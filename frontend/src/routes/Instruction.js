        ...
        >
          ...
          <Accordion defaultIndex={[0]} flex="2" color="white" allowToggle>
            ...
            <AccordionItem>
              ...
              <AccordionPanel>
                After purchasing, you'll receive the NFT in your digital wallet.
                You'll also receive a unique code that will be regenerated each
                time the NFT is transferred.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel>
                Present the code at the bubble tea shop and enjoy your
                discounted bubble tea.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel>
                As long as you own the NFT, you'll have unlimited access to free
                bubble tea at the shop. So sit back, relax, and enjoy!
              </AccordionPanel>
            </AccordionItem>
