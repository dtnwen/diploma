          ...
          <Stack direction={['column', null, 'row']}>
              <Box  ml='5vw' w={{md: '45%'}} alignSelf='center'>
                ...
                <Container ml='0'>
                  ...
                  <Button ml='0.5em' borderRadius='50px' fontFamily='base' fontWeight='bold' color='white' bgColor='#A75CC1' filter='drop-shadow(5px 7px 4px rgba(0, 0, 0, 0.25))' onClick={mint}>Get Now</Button>
                </Container>
              </Box>
